---
layout: post
title: "8 Things You Should Know About WebAssembly"
...
In this post we will explore 8 key facts about *WebAssembly*, one of the biggest changes the web will experience in the coming years. Will it meet the expectations? Read on!
...
## Fact 7: You do not need to wait for Web Assembly to be ready
...
## Fact 8: WebAssembly is what developers have been waiting for
