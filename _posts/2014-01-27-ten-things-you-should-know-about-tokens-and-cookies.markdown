...
<img src="http://assets.b-token.eu/files/445/original/gegraveerde_jetons.jpg" style="width: 400px; margin-left: auto; margin-right: auto; display: block;">
...
##5. When you need to stream something, use the token to get a signed requests
