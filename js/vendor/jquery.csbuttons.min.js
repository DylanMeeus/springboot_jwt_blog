			...
			switch(type)
			{
				case 'twitter': // Twitter share
					...
					if(count)
					{
						...
						$.getJSON('https://webtask.it.auth0.com/api/run/auth0/proxy?webtask_no_cache=1&url=http://opensharecount.com/count.json?url=' + $URL, function( twitdata ) {
              $('span.csbuttons-count', twitter).text(twitdata.count);
				...
				case 'linkedin' : // Linkedin share
					...
					if(count)
					{
						...
						$.getJSON('//www.linkedin.com/countserv/count/share?url=' + $URL + '&callback=?', function( indata ) {
